...
namespace PackedSerial
{
    ...
    static public class Utility
    {
        ...
        {
            combobox.Items.Clear();
            string[] speeds = new string[] { "9600", "19200", "38400", "57600", "115200", "230400", "460800", "921600" };
        ...
        public static int ConvertSpeed(string speed)
        {
            ...
            int[] standart_speeds = new int[] { 115200, 9600, 19200, 38400, 57600, 230400, 460800, 921600 };
